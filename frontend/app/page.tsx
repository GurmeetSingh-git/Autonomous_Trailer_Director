...
import { demoStoryMap, type Audience, type GeminiModel, uploadEpisode } from "@/lib/api";

export default function HomePage() {
  const [audience, setAudience] = useState<Audience>("family");
  const [model, setModel] = useState<GeminiModel>("gemini-3.5-flash-lite");
